...
const KusamaMigrationStats: React.FC<KusamaMigrationStatsProps> = ({ onBack }) => {
  ...
  const stats = {
    ...
    pallets: [
      { name: 'Accounts', duration: 'Coming Soon', items: 0 },
      { name: 'MultiSig', duration: 'Coming Soon', items: 0 },
      { name: 'Claims', duration: 'Coming Soon', items: 0 },
      { name: 'Proxy', duration: 'Coming Soon', items: 0 },
      { name: 'Preimage', duration: 'Coming Soon', items: 0 },
      { name: 'NomPools', duration: 'Coming Soon', items: 0 },
      { name: 'Vesting', duration: 'Coming Soon', items: 0 },
      { name: 'DelegatedStaking', duration: 'Coming Soon', items: 0 },
      { name: 'Indices', duration: 'Coming Soon', items: 0 },
      { name: 'Referenda', duration: 'Coming Soon', items: 0 },
      { name: 'BagsList', duration: 'Coming Soon', items: 0 },
      { name: 'Scheduler', duration: 'Coming Soon', items: 0 },
      { name: 'ConvictionVoting', duration: 'Coming Soon', items: 0 },
      { name: 'Bounties', duration: 'Coming Soon', items: 0 },
      { name: 'ChildBounties', duration: 'Coming Soon', items: 0 },
      { name: 'AssetRate', duration: 'Coming Soon', items: 0 },
      { name: 'Crowdloan', duration: 'Coming Soon', items: 0 },
      { name: 'Treasury', duration: 'Coming Soon', items: 0 },
      { name: 'Recovery', duration: 'Coming Soon', items: 0 },
      { name: 'Society', duration: 'Coming Soon', items: 0 },
      { name: 'Staking', duration: 'Coming Soon', items: 0 },
    ],
  };
